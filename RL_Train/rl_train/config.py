...
class LoggingConfig:
    ...
    metrics_path: str = "experiments/rl/runs/ppo_path/metrics.csv"
    tensorboard_dir: str = "experiments/rl/runs/ppo_path/tensorboard"
    run_state_path: str = "experiments/rl/runs/ppo_path/run_state.json"
...
class CheckpointConfig:
    ...
    keep_last_k: int = 5
    dir: str = "experiments/rl/runs/ppo_path/checkpoints"
...
class TrainConfig:
    ...
    output_dir: str = "experiments/rl/runs/ppo_path"
...
DEFAULT_CONFIG_DICT: Dict[str, Any] = {
    ...
    "logging": {
        ...
        "metrics_path": "experiments/rl/runs/ppo_path/metrics.csv",
        "tensorboard_dir": "experiments/rl/runs/ppo_path/tensorboard",
        "run_state_path": "experiments/rl/runs/ppo_path/run_state.json",
    },
    "checkpoint": {
        "every_env_steps": 2000,
        "keep_last_k": 5,
        "dir": "experiments/rl/runs/ppo_path/checkpoints",
    },
    "determinism": {
        "strict": True,
        "seed": 1234,
    ...
    "train": {
        ...
        "output_dir": "experiments/rl/runs/ppo_path",
    },
    "variant": {
        "name": "full",
    },
