...
def _evaluate_policy(
    ...
    if selector is not None:
        selector.eval()
    eval_shaping_gamma = cfg.ppo.gamma if cfg.trainer.algo == "ppo" else cfg.reinforce.gamma
    eval_env = GraphEnv(
        env_id=999,
        scheduler=scheduler,
        top_k=cfg.env.top_k,
        ...
        shaping_gamma=eval_shaping_gamma,
...
def run_training(
    ...
    shaping_gamma = cfg.ppo.gamma if cfg.trainer.algo == "ppo" else cfg.reinforce.gamma
