...
def _generate_figures(raw: "pd.DataFrame", summary_c: "pd.DataFrame | None",
    ...
    # Delegate to the standalone module for consistent font/size styling
    from generate_from_raw import generate_all
    generate_all(raw, summary_c, summary_q, fig_dir)
